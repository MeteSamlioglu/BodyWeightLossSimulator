...
def showPoints(source, target, img):
	for p in source:
		cv2.circle(img, (p[0], p[1]), r, [0, 0, 255])
	for p in target:
		cv2.circle(img, (p[0], p[1]), r, [255, 0, 0])
	cv2.imshow('w', img)
	cv2.waitKey(0)
 
 
# Zp = np.array([
#     [0, 0], [265, 0], [0, 550], [265, 550],
#     [105, 200], [100, 220], [180, 200], [185, 220]  # More points around belly
# ])

# Zs = np.array([
#     [0, 0], [265, 0], [0, 550], [265, 550],
#     [110, 200], [105, 220], [175, 200], [180, 220]  # Adjusted inward
# ])
